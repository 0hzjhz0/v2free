...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MN69TGmiTZbpoibdGcm%2F-MN6BJQ9QNJEWpp8cYwK%2Fimage.png?alt=media&token=1a507202-ad11-47d2-a608-ef65c847f25e)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MN6E1B0gJ_TakRKmn1w%2F-MNOdUodbUkIyuC_PvVX%2Fimage.png?alt=media&token=e20766c8-d452-489e-b91c-118df66fec45)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNOedUoWwf-B8e0x8xX%2F-MNQgPHLVuAReIvEfuv_%2Fimage.png?alt=media&token=64896819-7b22-4c88-b654-41786fe49cd9)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNOedUoWwf-B8e0x8xX%2F-MNQifH2z_uxd8s1bR7j%2Fimage.png?alt=media&token=6fa45459-e903-4e90-9fff-191f21dbbea9)

所有的设备都连接到处理器上，处理器上是通过Platform Level Interrupt Control，简称PLIC来处理设备中断。PLIC会管理来自于外设的中断。如果我们再进一步深入的查看PLIC的结构图，

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNOedUoWwf-B8e0x8xX%2F-MNQmPRa0bzPQ99lcE2p%2Fimage.png?alt=media&token=35741a0d-0fc6-42e9-a841-15537f9fdaf4)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNOedUoWwf-B8e0x8xX%2F-MNQoZbR7-IfNrutvz9o%2Fimage.png?alt=media&token=467d667a-4a28-4903-a535-f09b865628c7)

通常情况下，驱动中会有一些队列（或者说buffer），top部分的代码会从队列中读写数据，而Interrupt handler（bottom部分）同时也会向队列中读写数据。这里的队列可以将并行运行的设备和CPU解耦开来。

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNOedUoWwf-B8e0x8xX%2F-MNQp71Canf5lk9qGLXS%2Fimage.png?alt=media&token=74380443-5687-4173-b88c-a969825555fc)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNYTBg7E6HAPVxk89Ie%2F-MNYgr0LyJ8ULKLwHE50%2Fimage.png?alt=media&token=dea1a9dc-1bf8-4db2-8a8e-7f841c46f520)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNYhqAMxdVFIflbpxna%2F-MNYitmruHLfxrVpuvp2%2Fimage.png?alt=media&token=1eb71734-8620-46e9-b857-4ecc4ef81b3c)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNYn8xQ_nM7UyU1sa-g%2F-MNa5Rv4ANj0GOmpMXf9%2Fimage.png?alt=media&token=99fa1a9b-b983-46ec-9c0f-616220592cd9)

这里将所有的中断都设置在Supervisor mode，然后设置SIE寄存器来接收External，软件和定时器中断，之后初始化定时器。

接下来我们看一下main函数中是如何处理External中断。

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNYn8xQ_nM7UyU1sa-g%2F-MNa6N7vHde52fObSxUz%2Fimage.png?alt=media&token=65580d62-73c5-46eb-8767-e2fde2daac36)

我们第一个外设是console，这是我们print的输出位置。查看位于console.c的consoleinit函数。

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNYn8xQ_nM7UyU1sa-g%2F-MNa6mHXaOc6Dtv5U6bj%2Fimage.png?alt=media&token=80ea954c-2230-4eba-adcf-1a8e386bdb4a)

这里首先初始化了锁，我们现在还不关心这个锁。然后调用了uartinit，uartinit函数位于uart.c文件。这个函数实际上就是配置好UART芯片使其可以被使用。

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNYn8xQ_nM7UyU1sa-g%2F-MNa7OdMH3taGmHfE7Wj%2Fimage.png?alt=media&token=0538d371-3758-431d-98e6-907f5f5a6ab9)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNa7TJFrEQk2gYzkwCG%2F-MNcl8NhzO719lb6xtPl%2Fimage.png?alt=media&token=ceb45ee2-8509-48fb-9166-7d6bc9930fef)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNa7TJFrEQk2gYzkwCG%2F-MNcmoGEKLSU8ifrGFC6%2Fimage.png?alt=media&token=4bbb1a15-4f10-427c-961e-51b801adf8ef)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNa7TJFrEQk2gYzkwCG%2F-MNcnlTuggw_Il7m9iIW%2Fimage.png?alt=media&token=ac9df287-e059-4438-957e-548f1b22e030)

scheduler函数主要是运行进程。但是在实际运行进程之前，会执行intr_on函数来使得CPU能接收中断。

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNa7TJFrEQk2gYzkwCG%2F-MNcoC3QhbWZHXRz2BEt%2Fimage.png?alt=media&token=eca193c8-ff3d-4d96-b837-5cfbbc2b2ecc)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNa7TJFrEQk2gYzkwCG%2F-MNcplHF86eYTpFW_ztO%2Fimage.png?alt=media&token=e445273b-fd4d-4b8f-ad9a-100f621a2b62)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNa7TJFrEQk2gYzkwCG%2F-MNcqqRtbogpSiiEpc2P%2Fimage.png?alt=media&token=a1ae7eb6-b01d-4886-93ba-771f0bbe4182)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNa7TJFrEQk2gYzkwCG%2F-MNcryjzrhmCyPc7r_gD%2Fimage.png?alt=media&token=baf1d557-0d54-47c4-8cdf-29f409a1d04d)

所以由Shell输出的每一个字符都会触发一个write系统调用。之前我们已经看过了write系统调用最终会走到sysfile.c文件的sys_write函数。

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNa7TJFrEQk2gYzkwCG%2F-MNcsd0dxYGOsPE0DkWF%2Fimage.png?alt=media&token=690b04c3-fff7-4c46-85a0-44038c36c101)

这个函数中首先对参数做了检查，然后又调用了filewrite函数。filewrite函数位于file.c文件中。

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNa7TJFrEQk2gYzkwCG%2F-MNct2PHzPhwjA3hvi6V%2Fimage.png?alt=media&token=30bb0476-6724-473c-a36f-6ed0de37104f)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNa7TJFrEQk2gYzkwCG%2F-MNctcQci75CDpfVpdRq%2Fimage.png?alt=media&token=08880b86-4d8f-4b67-aa3c-cc5ce6cb17b0)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNa7TJFrEQk2gYzkwCG%2F-MNcu9oxFUI2qpie5z4T%2Fimage.png?alt=media&token=b0201ce3-225c-4696-a5e4-348e1b081bcc)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNa7TJFrEQk2gYzkwCG%2F-MNcudamCocCj7PtfYpv%2Fimage.png?alt=media&token=f9ff4004-3b5d-4c5a-bbf2-676d10dc2033)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNcv-xytcPNjgcA09N-%2F-MNfDMD08BsxVVcKpVl3%2Fimage.png?alt=media&token=58e70d9b-7dd2-46bb-8243-bb188dcb8307)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNfH5qMvmyxhegTFSUo%2F-MNpbLBt88M7WKDIGi4a%2Fimage.png?alt=media&token=6b9561db-5941-4caa-8187-809dae89a377)

在trap.c的devintr函数中，首先会通过SCAUSE寄存器判断当前中断是否是来自于外设的中断。如果是的话，再调用plic_claim函数来获取中断。

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNfH5qMvmyxhegTFSUo%2F-MNpcUmolzUjQhGtVWpo%2Fimage.png?alt=media&token=a894536b-a241-4230-8c0e-300d556275b6)

plic_claim函数位于plic.c文件中。在这个函数中，当前CPU核会告知PLIC，自己要处理中断，PLIC_SCLAIM会将中断号返回，对于UART来说，返回的中断号是10。

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNfH5qMvmyxhegTFSUo%2F-MNpdQCYQP1Gcv_HTm7o%2Fimage.png?alt=media&token=3dca463c-486f-4c96-87da-bc8401a65e94)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNfH5qMvmyxhegTFSUo%2F-MNpeCI5zYrIAIDEUzeD%2Fimage.png?alt=media&token=796177bb-eeb4-45d8-8502-2c60fac1b5ec)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNpiXXVKJdvWgWqzH_y%2F-MNrnl9JPFsR7yfGEs6s%2Fimage.png?alt=media&token=33e68a99-8451-4d9e-b6b4-d9fe0f6d95a2)

这里我将会关注在第一点，也就是producer/consumser并发。这是驱动中的非常常见的典型现象。如你们所见的，在驱动中会有一个buffer，在我们之前的例子中，buffer是32字节大小。并且有两个指针，分别是读指针和写指针。

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNpiXXVKJdvWgWqzH_y%2F-MNroXt11NpYEGZJisRG%2Fimage.png?alt=media&token=a739246a-07bf-43e8-b073-f63d4c707fd0)

如果两个指针相等，那么buffer是空的。当Shell调用uartputc函数时，会将字符，例如提示符“$”，写入到写指针的位置，并将写指针加1。这就是producer对于buffer的操作。

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNpiXXVKJdvWgWqzH_y%2F-MNropRpuu-7GKNWhYvX%2Fimage.png?alt=media&token=bf27dc51-13bc-46ca-b6ab-70d1ce8bf297)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNpiXXVKJdvWgWqzH_y%2F-MNrubhKUjW6DnLvxjQ6%2Fimage.png?alt=media&token=04539d08-79e8-463e-ad43-79b36da29eaa)

在我们的例子中，read函数就是console.c文件中的consoleread函数。

![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNpiXXVKJdvWgWqzH_y%2F-MNrv41RJWmQNiCKb4Ve%2Fimage.png?alt=media&token=e274c0e1-526c-49ab-83f9-f2a15447cd8f)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNpiXXVKJdvWgWqzH_y%2F-MNrvQJe25cNXU0LuIaw%2Fimage.png?alt=media&token=3a872797-b8ed-4d68-86ff-ff24403d2475)
...
![img](https://906337931-files.gitbook.io/~/files/v0/b/gitbook-28427.appspot.com/o/assets%2F-MHZoT2b_bcLghjAOPsJ%2F-MNrxZk5JKK8WT1bCv_K%2F-MNs0P8PukOn1-st2X5I%2Fimage.png?alt=media&token=ae576029-e271-4a0f-8c6e-ae85b1272d76)
